(function () {
  ...
  if (headerEl) {
    headerEl.innerHTML = '<nav>'
      ...
      + '<a href="chemistry.html" class="nav-dropdown-item">Химия</a>'
      + '<a href="physics.html" class="nav-dropdown-item">Физика</a>'
      + '<a href="medicine.html" class="nav-dropdown-item">Медицина</a>'
      + '</div>'
      + '</div>'
